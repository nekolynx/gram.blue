...
export default function Refetch(props: Props) {
  ...
  return (
    <Button
      ...
      className="text-skin-icon-muted border-skin-base bg-skin-base hover:text-skin-icon-base hover:bg-skin-secondary fixed bottom-24 right-0 z-40 mx-3 rounded-full border p-3 transition-all ease-linear hover:-rotate-180 md:bottom-8 md:ml-[0.80rem]"
      style={{
