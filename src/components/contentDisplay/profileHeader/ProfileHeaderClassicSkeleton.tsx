            ...
            <div className="mx-3 mb-3 mt-1">
                ...
                <div className="my-2">
                    <div className="flex items-center gap-1">
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-skin-tertiary" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
